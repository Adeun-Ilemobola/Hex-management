...
import { defaultPropertyListingInput, PropertyListingInput, SaleTypeEnumType, StatusEnumType } from '@/lib/Zod';
  ...
  const getSaleTypeColor = (saleType:string) => {
    ...
    return (
        <DropBack is={fetchListing.isPending}  >
            ...
            <div className="flex flex-col flex-1  min-w-[70%] m-auto">
                {isMounded && (<>
                    <div className="relative w-full h-[48vh] overflow-hidden mx-auto gap-6 px-4 py-6  ">

                        {/* Left buttons */}
                        <div className="absolute top-0 left-0 h-full w-24 flex items-center justify-center bg-blue-700/50 backdrop-blur-sm z-10" onClick={prevImage}>
                            {/* Buttons go here */}
                        </div>
                        ...
                        {/* Right buttons */}
                        <div className="absolute top-0 right-0 h-full w-24 flex items-center justify-center bg-blue-700/50 backdrop-blur-sm z-10" onClick={nextImage}>
                            {/* Buttons go here */}
                        </div>
                    </div>
                    {/* item details */}
