...
import { zodLoginSchema } from "@/lib/ZodObject";
...
export default function Page() {
  ...
  const form = useForm({
    defaultValues: {
      email: "",
      password: "",
    } as z.infer<typeof zodLoginSchema>,

    validators: {
      onChange: zodLoginSchema as any, // Validate on keystroke for immediate feedback
    },
    onSubmit: async ({ value }) => {
      // TanStack Form validates first, then runs this
              ...
              <form.Subscribe
                ...
                children={([canSubmit, isSubmitting]) => (
                  <Button
                    type="submit"
                    size="lg"
                    disabled={!canSubmit || isSubmitting || LoginMut.isPending}
                  ...
                  >
                    {LoginMut.isPending || isSubmitting ? (
